...
@Autonomous(name="BlueLeftRingSide", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class BlueLeftRingSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            driveByEncoder(0.95, 27, 27);
            robot.ShootyBoi.setPower(-0.75); //shot top goal
            driveByEncoder(0.4, -3.25, 3.25);

            for (int i = 0; i < 3; i++) {
                shoot();
            }

            robot.ShootyBoi.setPower(0); //shoot top goal
            driveByEncoder(0.55, 3.3, -3.3);


            switch (numRings) {
                case "FOUR":
                    //wobble
                    telemetry.addData("QUADQUADQUAD", 1);
                    robot.ShootyBoi.setPower(0);
                    driveByEncoder(0.8, 4, 0);
                    driveByEncoder(0.8,0,2);
                ...
                case "ONE":
                    ...
                    telemetry.update();
                    robot.ShootyBoi.setPower(0);
                    driveByEncoder(0.8, 25.5, 25.5);
                    driveByEncoder(0.5,0,2);
                    driveByEncoder(0.6,-13,13);
                    driveByEncoder(0.8, 1.2, 1.2);
                    //wobble
                    robot.BajelBoi.setPosition(0.354);
                    sleep(1500);
                    robot.BajuetteBoi.setPosition(0.765);
                    sleep(750);
                    //go back after wobble
                    driveByEncoder(0.8,-1.5,-1.5);
                    driveByEncoder(0.6, 13, -13);
                    driveByEncoder(0.8,-14.5,-14.5);

                    break;

                case "ZERO":
                    telemetry.addData("0000000000", 1);
                    robot.ShootyBoi.setPower(0);
                    robot.ShootyBoi.setPower(0);
                    driveByEncoder(0.8, 4, 0);
                    driveByEncoder(0.8,0,2);
