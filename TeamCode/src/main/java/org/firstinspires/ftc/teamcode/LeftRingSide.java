...
@Autonomous(name="LeftRingSide", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class LeftRingSide extends LinearOpMode {
...
*/
            ...
            ringDetect(tfod);
            sleep(1500);
            //driveByEncoder(1, 0, 1.95);//flat net: 1.15
            driveByEncoder(0.9, 12.5, 12.5);
            driveByEncoder(0.6,3.5,0);
            //strafe right
            ...
            switch (height) {
                case FOUR:
                    ...
                    telemetry.update();
                    //intake
                    driveByEncoder(0.8, 0, 5.9);
                    robot.RingPusher.setPosition(0.9);
                    robot.ShootyBoi.setPower(-0.78);
                    sleep(1000);
                    robot.DonutBoi.setPower(1);
                    robot.SuckyBoi.setPower(1);
                    robot.StuckBoi.setPower(-1);
                    sleep(1000);
                    driveByEncoder(0.32, -12.3, -12.3);
                    driveByEncoder(0.95, 10, 10);
                    sleep(1500);
                    //turn intake off
                    ...
                    //wobble
                    robot.ShootyBoi.setPower(0);
                    driveByEncoder(0.8, 0, 10.5);
                    driveByEncoder(1, 23.5, 23.5);
                    robot.BajelBoi.setPosition(0.33);
                    sleep(1500);
                    robot.BajuetteBoi.setPosition(0.55);
                    driveByEncoder(1, -15.5, -15.5);
                    break;
                ...
                case ONE:
                    ...
                    driveByEncoder(0.45, 0, 7.4);
                    driveByEncoder(0.9, 8, 8);
                    robot.BajelBoi.setPosition(0.33);
                    sleep(1350);
                    robot.BajuetteBoi.setPosition(0.55);
                    sleep(200);
                    ...
                    driveByEncoder(0.6, -20, -20);
                    sleep(1500);
                    robot.DonutBoi.setPower(0);
                    robot.SuckyBoi.setPower(0);
                    robot.StuckBoi.setPower(0);

                    driveByEncoder(0.6, 10, 10);
                    ...
                    driveByEncoder(1, 4.2069, 4.2069);
...
//                    driveByEncoder(0.7, -3, -3);
                ...
                case NONE:
                    ...
                    driveByEncoder(0.85, 0, 15.7);
                    robot.BajelBoi.setPosition(0.32);
                    sleep(1500);
                    robot.BajuetteBoi.setPosition(0.55);

                    //second wobble goal
                    //turn 180
                    driveByEncoder(1, -5.75, -5.75);
                    driveByEncoder(1, -24.75, 24.75);
                    driveByEncoder(0.8, 9,0);
                    driveByEncoder(0.8, 0, 7.5);
                    driveByEncoder(1, 11, 11);
                    driveByEncoder(0.6, 6.5, 6.5);

                    robot.BajuetteBoi.setPosition(0.78);
                    sleep(750);
                    robot.BajelBoi.setPosition(0.41);
                    sleep(100);
                    //goes back after getting wobble goal
                    driveByEncoder(1, -2, -2);
                    driveByEncoder(1, 24.5, -24.5);

                    driveByEncoder(1, 0, 12);
                    driveByEncoder(1,0.75,0);
                    driveByEncoder(1, 18.75, 18.75);
                    robot.BajelBoi.setPosition(0.32);
                    sleep(200);
                    robot.BajuetteBoi.setPosition(0.55);
                    sleep(500);
                    ...
                    driveByEncoder(1, -2, -2);
                    driveByEncoder(1, 12.5, 0);
                    driveByEncoder(1, 9.5, 9.5);
                    break;
