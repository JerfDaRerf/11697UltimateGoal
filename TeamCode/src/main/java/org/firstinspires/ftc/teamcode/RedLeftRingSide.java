...
@Autonomous(name="RedLeftRingSide", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class RedLeftRingSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.BajuetteBoi.setPosition(0.914);
        ...
        while (opModeIsActive()) {
            ...
            robot.ShootyBoi.setPower(-0.64);
            driveByEncoder(0.7, 31, 31);
            driveByEncoder(0.4,1.48,0);

            //driveByEncoder(0.6,1,0);
            //strafe right
            ...
            switch (height) {
                case FOUR:
                    ...
                    telemetry.update();
                    //intake
                    driveByEncoder(0.8, 0, 5);
                    robot.RingPusher.setPosition(0.9);
                    robot.ShootyBoi.setPower(-0.8);
                    ...
                    driveByEncoder(1, 10, -10);
                    driveByEncoder(1, -19, -19);
                ...
                case ONE:
                    ...
                    driveByEncoder(0.9, 16, 16);
                    driveByEncoder(0.6, 3, 0);
                    //wobble #1
                    robot.BajelBoi.setPosition(0.354);
                    sleep(1350);
                    ...
                    driveByEncoder(0.6, -6,-6);
                    robot.BajelBoi.setPosition(0.725);
                    robot.BajuetteBoi.setPosition(0.765);
                    driveByEncoder(0.6,7,0);
...
//                    driveByEncoder(0.7, -3, -3);
                ...
                case NONE:
                    ...
                    telemetry.update();
                    driveByEncoder(1,6,6);
                    driveByEncoder(0.6,-12,12);
                    driveByEncoder(0.9, 6, 6);
                    robot.BajelBoi.setPosition(0.354);
                    sleep(1500);
                    robot.BajuetteBoi.setPosition(0.765);
                    sleep(500);
            ...
            robot.ShootyBoi.setPower(0);
            robot.RingPusher.setPosition(0.3);
            break;
