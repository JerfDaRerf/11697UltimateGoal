...
@Autonomous(name="RedRightRingSide", group ="11697")
//BLUE Left has "public class BlueLeft extends LinearOpMode
public class RedRightRingSide extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            driveByEncoder(0.7, 26, 26);
            driveByEncoder(0.8, 6, 0);
            robot.ShootyBoi.setPower(-0.75); //shoot top goal
            sleep(500);
            ...
            driveByEncoder(0.9, 0, 9.69);
            driveByEncoder(0.6,2,0);
